...
output "gitops-cp-apic_name" {
  description = "The name of the module"
  value = module.gitops-cp-apic.name
}
output "gitops-cp-apic_branch" {
  description = "The branch where the module config has been placed"
  value = module.gitops-cp-apic.branch
}
output "gitops-cp-apic_namespace" {
  description = "The namespace where the module will be deployed"
  value = module.gitops-cp-apic.namespace
}
output "gitops-cp-apic_server_name" {
  description = "The server where the module will be deployed"
  value = module.gitops-cp-apic.server_name
}
output "gitops-cp-apic_layer" {
  description = "The layer where the module is deployed"
  value = module.gitops-cp-apic.layer
}
output "gitops-cp-apic_type" {
  description = "The type of module where the module is deployed"
  value = module.gitops-cp-apic.type
}
output "gitops-cp-apic-operator_name" {
  description = "The name of the module"
  value = module.gitops-cp-apic-operator.name
}
output "gitops-cp-apic-operator_branch" {
  description = "The branch where the module config has been placed"
  value = module.gitops-cp-apic-operator.branch
}
output "gitops-cp-apic-operator_namespace" {
  description = "The namespace where the module will be deployed"
  value = module.gitops-cp-apic-operator.namespace
}
output "gitops-cp-apic-operator_server_name" {
  description = "The server where the module will be deployed"
  value = module.gitops-cp-apic-operator.server_name
}
output "gitops-cp-apic-operator_layer" {
  description = "The layer where the module is deployed"
  value = module.gitops-cp-apic-operator.layer
}
output "gitops-cp-apic-operator_type" {
  description = "The type of module where the module is deployed"
  value = module.gitops-cp-apic-operator.type
}
...
output "gitops-cp-platform-navigator_name" {
  description = "The name of the platform navigator instance"
  value = module.gitops-cp-platform-navigator.name
}
output "gitops-cp-platform-navigator_namespace" {
  description = "The namespace where the platform navigator instance has been deployed"
  value = module.gitops-cp-platform-navigator.namespace
}
output "gitops-cp-platform-navigator_branch" {
  description = "The branch where the module config has been placed"
  value = module.gitops-cp-platform-navigator.branch
}
output "gitops-cp-platform-navigator_server_name" {
  description = "The server where the module will be deployed"
  value = module.gitops-cp-platform-navigator.server_name
}
output "gitops-cp-platform-navigator_layer" {
  description = "The layer where the module is deployed"
  value = module.gitops-cp-platform-navigator.layer
}
output "gitops-cp-platform-navigator_type" {
  description = "The type of module where the module is deployed"
  value = module.gitops-cp-platform-navigator.type
}
